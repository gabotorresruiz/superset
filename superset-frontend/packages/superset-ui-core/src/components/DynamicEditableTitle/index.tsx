...
export const DynamicEditableTitle = memo(
  ({
    ...
    // useLayoutEffect only re-measures on text change. The sizer can also reflow
    // after first paint (web font finishing loading, zoom, theme font swap),
    // which would otherwise leave the input at a stale, too-narrow width that
    // clips the title. Observing the sizer re-measures on any such reflow.
    useEffect(() => {
