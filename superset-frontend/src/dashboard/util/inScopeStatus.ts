...
/**
 * Writes the computed in-scope status (charts/tabs each native filter applies
 * to) into the native-filters and dashboardInfo Zustand stores.
 */
...
/**
 * Writes the computed in-scope status of chart customizations into the
 * native-filters and dashboardInfo Zustand stores.
 */
