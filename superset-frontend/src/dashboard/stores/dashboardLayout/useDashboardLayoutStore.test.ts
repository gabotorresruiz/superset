...
// zundo's temporal middleware is incompatible with the zustand auto-mock
// because it uses zustand internals during store creation. Jest hoists this
// before the import above, so the real zustand implementation is loaded.
jest.unmock('zustand');
