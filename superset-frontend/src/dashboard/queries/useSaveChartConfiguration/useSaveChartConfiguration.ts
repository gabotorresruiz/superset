...
/**
 * Persists the dashboard's chart cross-filter configuration and syncs the
 * resulting metadata into the dashboardInfo store / query cache. Exported for
 * the still-Redux saveDashboardRequest thunk, which persists it after a copy.
 */
