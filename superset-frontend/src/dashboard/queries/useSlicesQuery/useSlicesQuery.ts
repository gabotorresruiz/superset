...
/**
 * Looks up a slice by id across every cached `useSlicesQuery` result.
 * Used when a chart is dragged from the "add chart" panel onto the
 * dashboard — the slice metadata lives in this query's cache.
 */
